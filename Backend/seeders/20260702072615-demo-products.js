export const up = async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert('Products', [
      ...
      { title: "Samsung Galaxy Watch 6", description: "Smart watch with health features", price: 299.99, stock: 60, discount: 15, thumbnail: "https://picsum.photos/id/54/300/300", sellerId: 8, categoryId: 4, createdAt: new Date(), updatedAt: new Date() },
